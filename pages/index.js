...
*  Date:       12.07.2023
*  Vercel App: https://next-museum-ruby.vercel.app/
*
********************************************************************************/
...
export default function Home() {
  return (
    <Container>
      <Row>
        <Image alt='metropolianImg' src="https://upload.wikimedia.org/wikipedia/commons/3/30/Metropolitan_Museum_of_Art_%28The_Met%29_-_Central_Park%2C_NYC.jpg" width={700} height={500} />
      </Row>
      <Row>
        <Col md={6}>
